...
function searchResult(data: Todo[]) {
  todos.value = data;
}
...
<template>
  ...
  <div class="background">
    ...
    <TextareaForm @saved="updateTodo" @edited="edittodo" :editing-memo="editingMemo" />
    <SearchMemo @searched="searchResult" @initialize="updateTodo" />

    <ContentDisplay :todos="todos" @delete="updateTodo" @edit="senddata" @favorite="updateTodo" />
  </div>
</template>
